...
class AccelStateConstants : public QObject {
    Q_OBJECT
public:
    enum Enum {  };
...
class UAVOBJECTS_EXPORT AccelState: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xAD3C0E06;
    ...
    static AccelState* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
