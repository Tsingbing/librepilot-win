...
class AirspeedSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { AirspeedSensorTypeCount = 7,  };
...
class AirspeedSettings_AirspeedSensorType : public QObject {
    Q_OBJECT
public:
    enum Enum { PixHawkAirspeedMS4525DO, EagleTreeAirspeedV3, SDP3x, DIYDronesMPXV5004, DIYDronesMPXV7002, GroundSpeedBasedWindEstimation, None };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
public:
    ...
    // SamplePeriod
    // AirspeedSensorType
    typedef enum { AIRSPEEDSENSORTYPE_PIXHAWKAIRSPEEDMS4525DO=0, AIRSPEEDSENSORTYPE_EAGLETREEAIRSPEEDV3=1, AIRSPEEDSENSORTYPE_SDP3X=2, AIRSPEEDSENSORTYPE_DIYDRONESMPXV5004=3, AIRSPEEDSENSORTYPE_DIYDRONESMPXV7002=4, AIRSPEEDSENSORTYPE_GROUNDSPEEDBASEDWINDESTIMATION=5, AIRSPEEDSENSORTYPE_NONE=6 } AirspeedSensorTypeOptions;


    // Constants
    static const quint32 OBJID = 0xAC603F8;
