...
public:
    ...
    void retranslateUi(QWidget *UAVObjectBrowser)
    {
        ...
        searchLine->setPlaceholderText(QCoreApplication::translate("UAVObjectBrowser", "type filter text", nullptr));
        searchClearButton->setText(QCoreApplication::translate("UAVObjectBrowser", "Clear", nullptr));
