...
#include <memory>
#include "../../../../../ground/gcs/src/libs/utils/filelogger.h"
...
QT_MOC_LITERAL(5, 33, 3) // "msg"
    ...
    "FileLogger\0doLog\0\0QtMsgType\0type\0msg"
};
...
void FileLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doLog((*reinterpret_cast< QtMsgType(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
