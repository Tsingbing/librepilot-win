...
#include <memory>
#include "../../../../../ground/gcs/src/libs/utils/mytabwidget.h"
...
QT_MOC_LITERAL(1, 12, 8), // "tabMoved"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "from"
QT_MOC_LITERAL(4, 27, 2), // "to"
QT_MOC_LITERAL(5, 30, 10) // "myTabMoved"

    },
    "MyTabWidget\0tabMoved\0\0from\0to\0myTabMoved"
};
...
void MyTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myTabMoved((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyTabWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTabWidget::tabMoved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTabWidget::tabMoved(int _t1, int _t2)
{
