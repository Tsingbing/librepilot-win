...
#include <memory>
#include "../../../../../ground/gcs/src/plugins/uavobjectbrowser/treeitem.h"
...
QT_MOC_LITERAL(1, 17, 15), // "updateHighlight"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9), // "TreeItem*"
QT_MOC_LITERAL(4, 44, 4), // "item"
QT_MOC_LITERAL(5, 49, 17) // "checkItemsExpired"

    },
    "HighlightManager\0updateHighlight\0\0"
    "TreeItem*\0item\0checkItemsExpired"
};
...
void HighlightManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->checkItemsExpired(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HighlightManager::*)(TreeItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HighlightManager::updateHighlight)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HighlightManager::updateHighlight(TreeItem * _t1)
{
