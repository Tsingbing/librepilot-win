...
AirspeedSettings::AirspeedSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    AirspeedSensorTypeEnumOptions << "PixHawkAirspeedMS4525DO" << "EagleTreeAirspeedV3" << "SDP3x" << "DIYDronesMPXV5004" << "DIYDronesMPXV7002" << "GroundSpeedBasedWindEstimation" << "None";
