...
class ActuatorSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { BankModeCount = 6, ChannelTypeCount = 6, MotorsSpinWhileArmedCount = 2, LowThrottleZeroAxisCount = 2,  };
...
class ActuatorSettings_BankMode : public QObject {
    Q_OBJECT
public:
    enum Enum { PWM, PWMSync, OneShot125, OneShot42, MultiShot, DShot };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class UAVOBJECTS_EXPORT ActuatorSettings: public UAVDataObject
{
    ...
    Q_PROPERTY(quint16 dShotMode READ dShotMode WRITE setDShotMode NOTIFY dShotModeChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint16 DShotMode READ getDShotMode WRITE setDShotMode NOTIFY DShotModeChanged);
...
public:
    ...
    // BankMode
    typedef enum { BANKMODE_PWM=0, BANKMODE_PWMSYNC=1, BANKMODE_ONESHOT125=2, BANKMODE_ONESHOT42=3, BANKMODE_MULTISHOT=4, BANKMODE_DSHOT=5 } BankModeOptions;
    ...
    // Constants
    static const quint32 OBJID = 0x70500090;
    ...
    quint16 dShotMode() const;
    /*DEPRECATED*/ Q_INVOKABLE quint16 getDShotMode() const { return static_cast<quint16>(dShotMode()); }
...
public slots:
    ...
    void setDShotMode(const quint16 value);
...
signals:
    ...
    void dShotModeChanged(const quint16 value);
    /*DEPRECATED*/ void DShotModeChanged(quint16 value);
